	...
	public function html_field_list($databasename,$tablename){
		...
		while ( $arr = mysql_fetch_assoc($query)) {
			...
			if($coltype == "varchar"){
				switch ($type){
					case 'photo':
						$input ="<input {\$readonly} name='{$colname}' type='file' />";
						break;
					case 'sex':
						$input = "<select name='{$colname}'><option>请选择</option><option value='女'>女</option><option value='男'>男</option></select>";
						break;
					case 'birth':
						$input = "<select name='{$colname}'><option>请选择</option><option value='女'>女</option><option value='男'>男</option></select>年".
							"<select name='{$colname}'><option>请选择</option><option value='女'>女</option><option value='男'>男</option></select>月".
							"<select name='{$colname}'><option>请选择</option><option value='女'>女</option><option value='男'>男</option></select>日";
						break;
					case 'edu':
						$input = "<select name='{$colname}'><option>请选择</option><option value='女'>女</option><option value='男'>男</option></select>"
						break;
					...
					case 'addr':
						break;
					default:
						$input ="<input {\$readonly} name='{$colname}' value='{\${$tablename}.{$colname}}'/>";
						break;
				}
			}else if($coltype == "text"){
				$input ="<textarea {\$readonly} name='{$colname}' />{\${$tablename}.{$colname}}</textarea>";
			}else if($coltype == "int" || $coltype == "tinyint" || $coltype == "mediumint" || $coltype == "double"){
				$input ="<input {\$readonly} name='{$colname}' value='{\${$tablename}.{$colname}}'/>";
			}
			$trs .= "<tr ".($type=="id"?"hidden":"").">
				<td>{$comment}:</td>
				<td>"
				.$input.
				"</td>
