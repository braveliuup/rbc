...
define('ROOT_PATH', str_replace(ADMIN_PATH . '/includes/init_emp.php', '', str_replace('\\', '/', __FILE__)));
...
//
///* 验证管理员身份 */
//    if(isset($_SESSION['app']) && $_SESSION['app'] !== 'rbc_emp'){
//        $sess->destroy_session();
//        ecs_header("Location: ./empAdmin.php\n");
//    }
